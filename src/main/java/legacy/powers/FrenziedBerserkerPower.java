...
public class FrenziedBerserkerPower extends PrestigeClassPower {
  ...
  public static final String POWER_ID = "legacy:frenzied_beserker_power";
  ...
  public void onRemove() {
    ...
    addToBot(new ApplyPowerAction(this.owner, this.owner, new StrengthPower(this.owner, -1 * this.strengthIncrease), -1 * this.strengthIncrease));
    if (((AbstractPlayer) this.owner).stance.ID.equals("Wrath")) {
     addToBot(new ChangeStanceAction("Netural"));
    }
  }
