...
import legacy.patches.relics.BottledPlaceholderField;
import legacy.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static legacy.LegacyMod.makeRelicOutlinePath;
import static legacy.LegacyMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = LegacyMod.makeID("BottledPlaceholderRelic");
